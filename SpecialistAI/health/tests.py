...
class UserTestCase(TestCase):
    ...
    def setUp(self):
        ...
        h = Hospital.objects.create(name="University of Rochester Medical Center",
                                    address="601 Elmwood Ave", county="New York", city="Rochester",
                                    postal_code="14620")

        h2 = Hospital.objects.create(name="RIT Health Center",
                                    address="1 Lomb Memorial Drive", county="New York", city="Rochester",
                                    postal_code="14623")

        h3 = Hospital.objects.create(name="Highland Hospital",
                                     address="1000 South Ave", county="New York", city="Rochester",
                                     postal_code="14620")
